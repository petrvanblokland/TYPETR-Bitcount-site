...
EXPORT_PATH = 'response/img/BitcountLayerCatalogAnimation1920x1080.gif'

USE_BITPATH = False

# Initial sample text. Can be altered in the text box of the popup window.
W = 1920 # Width of the sample image. TypeNetwork preference 2040 x 1020
H = 1080 # Height of the sample image
